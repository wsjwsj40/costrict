 ...
 *
 * This class manages the state for the marketplace view in the DiCode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the DiCode extensions interface
